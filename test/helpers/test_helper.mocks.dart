...
import 'package:ditonton/data/models/tvseries_model.dart' as _i21;
import 'package:ditonton/data/models/tvseries_table.dart' as _i23;
...
import 'package:ditonton/domain/entities/tvseries.dart' as _i18;
import 'package:ditonton/domain/entities/tvseries_detail.dart' as _i19;
...
/// A class which mocks [TvSeriesRespositories].
///
/// See the documentation for Mockito's code generation for more information.
class MockTvSeriesRespositories extends _i1.Mock
    implements _i17.TvSeriesRespositories {
  MockTvSeriesRespositories() {
    _i1.throwOnMissingStub(this);
  }
...
class MockDatabaseHelper extends _i1.Mock implements _i24.DatabaseHelper {
  ...
  @override
  _i8.Future<Map<String, dynamic>?> getMovieByIdMovies(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #getMovieByIdMovies,
          [id],
  ...
  @override
  _i8.Future<Map<String, dynamic>?> getTvSeriesByIdTvSeries(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #getTvSeriesByIdTvSeries,
          [id],
        ),
        returnValue: _i8.Future<Map<String, dynamic>?>.value(),
      ) as _i8.Future<Map<String, dynamic>?>);
  ...
  @override
  _i8.Future<List<Map<String, dynamic>>> getWatchlistTvSerires() =>
      (super.noSuchMethod(
        Invocation.method(
          #getWatchlistTvSerires,
          [],
        ),
        returnValue: _i8.Future<List<Map<String, dynamic>>>.value(
            <Map<String, dynamic>>[]),
